...
const mainSectionData = {
  ...
  role: 'Старший React Разработчик',
  details: [
    { label: 'Телефон', value: '605 475 6961', url: 'tel:605 475 6961' },
    { label: 'Email', value: 'mark.freeman.dev@gmail.com', url: 'mailto:mark.freeman.dev@gmail.com' },
    { label: 'Откуда', value: 'Варшава, Польша' },
    { label: 'Зарплата', value: '18 000 - 25 000 PLN' },
  ],
  pdfDetails: [
    { label: 'Телефон', value: '605 475 6961' },
    ...
    { label: 'Сайт', value: 'mark-freeman-personal-website.com', url: '/', fullRow: true },
  ],
  description:
    'Lorem ipsum dolor sit amet, consectetur **adipiscing elit**. In sodales ac dui at *vestibulum*. In condimentum metus id dui tincidunt, in blandit mi [vehicula](/). Nulla lacinia, erat sit amet elementum vulputate, lectus mauris volutpat mi, vitae accumsan metus elit ut nunc. Vestibulum lacinia enim eget eros fermentum scelerisque. Proin augue leo, posuere ut imperdiet vitae, fermentum eu ipsum. Sed sed neque sagittis, posuere urna nec, commodo leo. Pellentesque posuere justo vitae massa volutpat maximus.',
  tags: [{ name: 'Открыт для фриланса' }, { name: 'Доступен для менторства' }, { name: 'Работаю над сайд-проектом' }],
  action: {
    label: 'Скачать CV',
    url: '/cv.pdf',
