...
sections:
  - type: main
    data:
      ...
      image: https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=160&h=240&fit=crop&crop=face
      description: |
        ...
        - title: Общие
          skills:
            - name: React.js
              ...
              icon: logos:react
              color: "#61dafb"
              description: Современная разработка на React с хуками и функциональными компонентами
            - name: TypeScript
              level: advanced
